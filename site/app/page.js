...
const experience=[
 ...
 {company:'VIADEX',role:'Marketing Intern / Junior GTM Engineer',summary:'Built AI-first outbound systems, enrichment architecture, integrations and enablement supporting 16+ qualified enterprise meetings per month.',tags:['CLAY','LEMLIST','N8N','GTM'],icon:'/logos/viadex.jpg'},
 {company:'VX-ONE',role:'Junior Technical Analyst',summary:'Delivered DEX tooling, automation, ITSM integrations and platform documentation across a large enterprise estate.',tags:['NEXTHINK DEX','POWERSHELL','AZURE','ITSM'],icon:'/logos/vx-one.jpg'},
 {company:'RECYCL JUNCTION',role:'Digital / Technical Work',summary:'Digital and technical delivery work as part of three years of professional experience spanning technology, consulting, marketing and delivery.',tags:['WEB DELIVERY','DIGITAL OPS'],icon:'/logos/recycl-junction.png'}
];
...
const flagship=[
 ...
 {title:'ALCOVE',kind:'MOBILE / DISCOVERY',copy:'Furniture discovery product matching people with furniture based on taste, room and budget through a guided, visual discovery experience rather than a traditional catalogue search.',tags:['MOBILE','RECOMMENDATION','UX','BRAND'],icon:'/logos/alcove.png',links:[{type:'repo',href:'https://github.com/CodeCreatorManMike/Alcove',label:'VIEW REPO ↗'}]},
